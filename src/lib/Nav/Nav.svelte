<nav
  class="max-w-200 m-8 p-2 rounded-md bg-slate-200 flex flex-row gap-1 justify-around items-center"
>
  ...
  <a
    ...
    aria-current="true">Svelte playground</a
  >
  <a href="https://github.com/sfmunoz/svelte-playground">
    <svg class="size-6 mr-1 inline align-sub rounded-3xl" viewBox="0 0 32 32">
      <path
